    ...
    */
    ...
    function renderPagination()
    {
        if (this.options.navigation !== 0)
        {
            ...
            if (this.rowCount !== -1 && paginationItems.length > 0)
            {
                ...
                renderPaginationItem.call(this, pagination, "first", "<i class=\"mdl2icon mdl2-left pagination-mdl2icon\"></i>", "first")
                    ._bgEnableAria(current > 1);
                renderPaginationItem.call(this, pagination, "prev", "<i class=\"mdl2icon mdl2-pagination-previous pagination-mdl2icon\"></i>", "prev")
                    ._bgEnableAria(current > 1);
                ...
                renderPaginationItem.call(this, pagination, "next", "<i class=\"mdl2icon mdl2-pagination-next pagination-mdl2icon\"></i>", "next")
                    ._bgEnableAria(totalPages > current);
                renderPaginationItem.call(this, pagination, "last", "<i class=\"mdl2icon mdl2-right pagination-mdl2icon\"></i>", "last")
                    ._bgEnableAria(totalPages > current);
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            icon: "icon mdl2icon",
            iconColumns: "mdl2-columns",
            iconDown: "sorting-mdl2icon mdl2-down",
            iconRefresh: "mdl2-sync",
            iconSearch: "mdl2-search",
            iconUp: "sorting-mdl2icon mdl2-up",
        ...
        templates: {
            ...
            infos: "<div class=\"{{css.infos}}\" style=\"height: 42.2px; line-height: 42.2px; vertical-align: middle\"><span data-toggle=\"tooltip\" title=\"RESULTS COUNTER\" data-placement=\"left\">{{lbl.infos}}</span></div>",
