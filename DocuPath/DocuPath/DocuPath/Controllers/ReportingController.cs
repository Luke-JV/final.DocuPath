    ...
    public class ReportingController : Controller
    {
        ...
        public ViewResult Insight(ReportingViewModel model)
        {
            ...
            try
            {
                ...
                var YESTERDAY = TODAY_MIDN.AddDays(-1);
                var LAST_WEEK = TODAY_MIDN.AddDays(-7);
                var PREV_WEEK = TODAY_MIDN.AddDays(-14);
                ...
                switch (model.iq.reportToGenerate)
                {
                    ...
                    case 8: // USER ACTIVITY
                        ...
                        // Grouped by:
                        newUARDataSet.dsGroupedBy = "Date";
                        // Sorted by:
                        newUARDataSet.dsSortedBy = "Timestamp Descending";
                        // Timeframe:
                        switch (model.iq.reportTimeframe)
                        {
                            case 1: // TODAY
                        ...
                        // Number of Entries:
                        newUARDataSet.dsNumEntries = newUARDataSet.dsUAR.Count;
